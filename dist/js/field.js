...
Nova.booting(function (Vue, router) {
    Vue.component('detail-nova-dependency-container', __webpack_require__(3));
    Vue.component('form-nova-dependency-container', __webpack_require__(6));
});
...
var render = function() {
  ...
  return _vm.dependenciesSatisfied
    ? _c(
        "div",
        _vm._l(_vm.field.fields, function(childField) {
          return _c(
            "div",
            [
              _c("detail-" + childField.component, {
      ...
      root.$children.forEach(function (component) {
        if (_this.componentIsDependency(component)) {
          component.$watch("value", function (value) {
            _this.dependencyValues[component.field.attribute] = value;
            _this.updateDependencyStatus();
          }, { immediate: true });

          _this.dependencyValues[component.field.attribute] = component.field.value;
        }
    ...
    updateDependencyStatus: function updateDependencyStatus() {
      ...
      try {
        for (var _iterator2 = this.field.dependencies[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
          ...
          if (dependency.hasOwnProperty("regex") && this.dependencyValues[dependency.field] && !this.dependencyValues[dependency.field].match(new RegExp(dependency.regex, "g"))) {
            this.dependenciesSatisfied = false;
            return;
          }
        }
